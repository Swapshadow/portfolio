...
const I18N_MESSAGES = {
  fr: {
    ...
    'hero.summary1': 'Je conçois, sécurise et documente des environnements systèmes, réseaux et cloud avec une approche orientée infrastructure, audit, conformité et amélioration continue.',
    'hero.summary2': 'Actuellement en alternance, je construis une expertise orientée infrastructures critiques, sécurité opérationnelle et conformité cyber.',
    'hero.badge1': 'Infrastructure sécurisée',
    'hero.badge2': 'Administration système & réseau',
    'hero.badge3': 'Audit & durcissement',
    'hero.badge4': 'Veille cyber',
    'hero.badge5': 'Pentest junior',
    'hero.metric1': 'Projets, labs & déploiements techniques',
    'hero.metric2': 'Certifications & formations validées',
    'hero.metric3': 'Veille cybersécurité & CTI',
    'hero.cta1': 'Découvrir mon parcours',
    'hero.cta2': 'Voir mes projets',
    'hero.cta3': 'Consulter ma veille cyber',
    'build.title': 'Ce que je construis actuellement',
    'build.intro': 'Une sélection de projets et travaux en cours autour de l’infrastructure, de la cybersécurité, de la gouvernance et de la documentation technique.',
    'build.card1.title': 'Intranet professionnel',
    'build.card1.text': 'Développement d’un intranet moderne avec annuaire, actualités, accès métiers et intégration progressive à l’environnement Microsoft/Active Directory.',
    'build.card2.title': 'Cartographie & inventaire SI',
    'build.card2.text': 'Mise en place d’une vision structurée des actifs, applications, VLAN, serveurs et services critiques pour renforcer la gouvernance cyber.',
    'build.card3.title': 'Gouvernance & conformité',
    'build.card3.text': 'Travaux autour de la PSSI, du PCA/PRA, de NIS 2 et des bonnes pratiques ANSSI/NIST.',
    'build.card4.title': 'Labs cybersécurité',
    'build.card4.text': 'Environnements de test autour de Docker, GLPI, NetBox, supervision, durcissement Linux/Windows et analyse réseau.',
  ...
  en: {
    ...
    'hero.summary1': 'I design, secure, and document systems, network, and cloud environments with a focus on infrastructure, auditing, compliance, and continuous improvement.',
    'hero.summary2': 'Currently in a work-study role, I am building expertise in critical infrastructure, operational security, and cyber compliance.',
    'hero.badge1': 'Secure Infrastructure',
    'hero.badge2': 'System & Network Administration',
    'hero.badge3': 'Audit & Hardening',
    'hero.badge4': 'Cyber Threat Watch',
    'hero.badge5': 'Junior Pentest',
    'hero.metric1': 'Projects, labs & technical deployments',
    'hero.metric2': 'Certifications & completed training',
    'hero.metric3': 'Cybersecurity watch & CTI',
    'hero.cta1': 'Explore my journey',
    'hero.cta2': 'View my projects',
    'hero.cta3': 'Read my cyber watch',
    'build.title': 'What I am currently building',
    'build.intro': 'A selection of ongoing projects focused on infrastructure, cybersecurity, governance, and technical documentation.',
    'build.card1.title': 'Professional Intranet',
    'build.card1.text': 'Building a modern intranet with directory, news feed, business access, and gradual integration with Microsoft/Active Directory environments.',
    'build.card2.title': 'IS Mapping & Inventory',
    'build.card2.text': 'Implementing a structured view of assets, applications, VLANs, servers, and critical services to strengthen cyber governance.',
    'build.card3.title': 'Governance & Compliance',
    'build.card3.text': 'Working on IS security policy, BCP/DRP, NIS 2, and ANSSI/NIST best practices.',
    'build.card4.title': 'Cybersecurity Labs',
    'build.card4.text': 'Testing environments around Docker, GLPI, NetBox, monitoring, Linux/Windows hardening, and network analysis.',
